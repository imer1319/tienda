        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                        ...
                        <div class="col-md-5">
                            <table class="table">
                                <tbody>
                                    ...
                                    <tr>
                                        <th>Ciudad</th>
                                        <td>{{ $pedido->client->profile->ciudad }}</td>
                                    </tr>
                                    <tr>
                                        <th>Fecha</th>
                                    ...
                                    <tr>
                                        <th>Items</th>
                                        <td>
                                            <span class="badge badge-primary">{{ count($pedido->detalles) }}</span>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
                    ...
                    <div class="modal fade" id="deudas" tabindex="-1" role="dialog" aria-labelledby="deudasLabel"
                        aria-hidden="true">
