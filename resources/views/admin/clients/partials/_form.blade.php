...
<div class="row">
    ...
    <div class="form-group col-md-6">
        ...
        <input type="text" class="form-control @error('apellido_paterno') is-invalid @enderror" name="apellido_paterno"
            value="{{ old('apellido_paterno', $client->apellido_paterno) }}">
    ...
    <div class="form-group col-md-6">
        ...
        <input type="text" class="form-control @error('apellido_materno') is-invalid @enderror"
            name="apellido_materno" value="{{ old('apellido_materno', $client->apellido_materno) }}">
    ...
    <div class="form-group col-md-6">
        ...
        <input type="date" class="form-control @error('fecha_nacimiento') is-invalid @enderror"
            name="fecha_nacimiento" value="{{ old('fecha_nacimiento', $client->fecha_nacimiento) }}">
